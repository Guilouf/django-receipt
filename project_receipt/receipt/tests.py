...
class FormsTestCase(TestCase):
    ...
    def test_receipt_form(self):
        """Check if allowed tags can be linked with a receipt, and also checks if
    ...
    def test_company_form(self):
        """Check if allowed tags can be linked with a company, and also checks if
        unauthorised tags are refused"""
        company_form_data = {'name': 'Companini'}

        # Allowed tags
        form_data = {**company_form_data,
                     'tags': [self.tag_company.id, self.tag_both.id]
                     }
